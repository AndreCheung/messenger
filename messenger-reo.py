#! python3
# messenger-reo.py - Get image from reolink camera with IP address 192.168.1.175 and sent it to LookOut
...
inputUrl = 'http://192.168.1.175/cgi-bin/api.cgi?cmd=Snap&channel=0&rs=123456&user=wildfire&password=detection'
lookoutUrl = 'https://lax.pop.roboticscats.com/api/detects?apiKey=f9600831000ad11c74841d376bdc6bf5'
lookoutName = 'Reolink-820A'
